...
public final class Objects {
    ...
    */
    ...
    public static boolean hasIdentity(@Nullable Object obj) {
    ...
    @PreviewFeature(feature = PreviewFeature.Feature.VALUE_OBJECTS, reflective = true)
    @ForceInline
    public static <T> T requireIdentity(T obj, @Nullable String message) {
        Objects.requireNonNull(obj);
        if (!hasIdentity(obj))
    ...
    @PreviewFeature(feature = PreviewFeature.Feature.VALUE_OBJECTS, reflective = true)
    @ForceInline
    public static <T> T requireIdentity(T obj, @Nullable Supplier<String> messageSupplier) {
        Objects.requireNonNull(obj);
        if (!hasIdentity(obj))
